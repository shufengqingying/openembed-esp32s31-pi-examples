...
|---:|:---:|:---|
|1|J1|All available GPIO pins are broken out to header J1 for easy external connection. For details, please refer to Pin Headers.|
|2|RJ45 Ethernet Port|Supports 10/100/1000 Mbps auto-negotiation Ethernet port.|
...
|7|RGB LED|Addressable RGB LED, driven by GPIO60.|
...
|12|Onboard Terminal Block|2.0mm pitch 4-pin female header, used for physical connection and fixation of external power or signals.|
...
|15|microSD Card Slot|This development board supports 4-bit mode microSD cards, which can store or play audio files from the microSD card. Supports SDIO 3.0 protocol.|
